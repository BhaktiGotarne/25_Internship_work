...
<footer  style="background: #2d3246;">
                ...
                <p>E-Learning.. is an excellent learning hub, dedicated to the programmer who want to explore.</p>
                <!-- Rights-->
                <p class="rights"><span>©  </span><span class="copyright-year">2018</span><span> </span><span>E-Learning..</span><span>. </span><span>All Rights Reserved.</span></p>
              </div>
            </div>
            <div class="col-md-4">
              <h5>Contacts</h5>
              ...
              <dl class="contact-list">
                <dt>email:</dt>
                <dd><a href="mailto:#">elearning0@gmail.com</a></dd>
              </dl>
              <dl class="contact-list">
                <dt>phones:</dt>
